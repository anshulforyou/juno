	...
	tests := []struct {
	...
	}{
		{
			...
			&core.Block{
				...
				SequencerAddress:      hexToFelt("0x46a89ae102987331d369645031b49c27738ed096f2789c24449966da4c6de6b"),
				Timestamp:             uintToFelt(1654526121),
				TransactionCount:      uintToFelt(65),
				TransactionCommitment: hexToFelt("0x73a0e2053e3ab5c3e23f656bdb8c6055e572174426a9453db4a486835cfd596"),
				EventCount:            uintToFelt(89),
				EventCommitment:       hexToFelt("0x125a4eebce8aa3f9f0825c15d93a06f0977d55799aa2917d040bffe30ac444a"),
				ProtocolVersion:       uintToFelt(0),
				ExtraData:             hexToFelt(""),
			},
			0,
		...
		},
		{
			...
			&core.Block{
				...
				SequencerAddress:      nil,
				Timestamp:             uintToFelt(1649872212),
				TransactionCount:      uintToFelt(29),
				TransactionCommitment: hexToFelt("0x24638e0ca122d0260d54e901dc0942ea68bd1fc40a96b5da765985c47c92500"),
				EventCount:            uintToFelt(55),
				EventCommitment:       hexToFelt("0x5d25e41d43b00681cc63ed4e13a82efe3e02f47e03173efbd737dd52ba88c7e"),
				ProtocolVersion:       uintToFelt(0),
				ExtraData:             hexToFelt(""),
			},
			0,
		...
		},
		{
			...
			&core.Block{
				...
				SequencerAddress:      nil,
				Timestamp:             uintToFelt(1636989916),
				TransactionCount:      uintToFelt(4),
				TransactionCommitment: hexToFelt("0x18bb7d6c1c558aa0a025f08a7d723a44b13008ffb444c432077f319a7f4897c"),
				EventCount:            uintToFelt(0),
				EventCommitment:       hexToFelt("0x0"),
				ProtocolVersion:       uintToFelt(0),
				ExtraData:             hexToFelt(""),
			},
			0,
		...
		},
		{
			...
			&core.Block{
				...
				SequencerAddress:      hexToFelt("0x5dcd266a80b8a5f29f04d779c6b166b80150c24f2180a75e82427242dab20a9"),
				Timestamp:             uintToFelt(1671087773),
				TransactionCount:      uintToFelt(214),
				TransactionCommitment: hexToFelt("0x580a06bfc8c3fe39bbb7c5d16298b8928bf7c28f4c31b8e6b48fc25cd644fc1"),
				EventCount:            uintToFelt(962),
				EventCommitment:       hexToFelt("0x6f499789aabb31935810ce89d6ea9e9d37c5921c0d7fae2bd68f2fff5b7b93f"),
				ProtocolVersion:       hexToFelt("0x1"),
				ExtraData:             hexToFelt(""),
			},
			1,
		...
		},
		{
			...
			&core.Block{
				...
				SequencerAddress:      nil,
				Timestamp:             uintToFelt(1638978017),
				TransactionCount:      uintToFelt(4),
				TransactionCommitment: hexToFelt("0xbf11745df434cbd284e13ca36354139a4bca2f6722e737c6136590990c8619"),
				EventCount:            uintToFelt(0),
				EventCommitment:       hexToFelt("0x0"),
				ProtocolVersion:       uintToFelt(0),
				ExtraData:             hexToFelt(""),
		...
		},
		{
			...
			&core.Block{
				...
				SequencerAddress:      nil,
				Timestamp:             uintToFelt(1647251113),
				TransactionCount:      uintToFelt(24),
				TransactionCommitment: hexToFelt("0x3d31908e135bac6a6cea1eba760e845ba8e78b4970a5f7265b7792fb5a19470"),
				EventCount:            uintToFelt(27),
				EventCommitment:       hexToFelt("0x2016910f3a2fd5d241fde8c15c44a7cd0eafe6cdacb903822bd587c28e910b8"),
				ProtocolVersion:       uintToFelt(0),
				ExtraData:             hexToFelt(""),
			},
			0,
		...
		},
		{
			...
			&core.Block{
				...
				SequencerAddress:      hexToFelt("0x46a89ae102987331d369645031b49c27738ed096f2789c24449966da4c6de6b"),
				Timestamp:             uintToFelt(1666883141),
				TransactionCount:      uintToFelt(1),
				TransactionCommitment: hexToFelt("0x66dba4a3fa3b67af8f0469e58a064b837728f33328331b242c21bce5af03140"),
				EventCount:            uintToFelt(1),
				EventCommitment:       hexToFelt("0x160e8a530c118d3266447d46d29c7e9263ee59cf2da494d8339b0af9aae9427"),
				ProtocolVersion:       uintToFelt(1),
				ExtraData:             hexToFelt(""),
			},
			2,
		...
		},
		{
			...
			&core.Block{
				...
				SequencerAddress:      nil,
				Timestamp:             uintToFelt(1637069048),
				TransactionCount:      uintToFelt(18),
				TransactionCommitment: hexToFelt("0x27821704010baa1479045e0063dcebca597d3a0d4fe5fe44a6edbbe68225bf2"),
				EventCount:            uintToFelt(0),
				EventCommitment:       hexToFelt("0x0"),
				ProtocolVersion:       uintToFelt(0),
				ExtraData:             hexToFelt(""),
